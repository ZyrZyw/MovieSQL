...
class MovieInfoForm(forms.ModelForm):
    ...
    film_name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}),
                                max_length=50,label=u'电影名',required=True)
    region = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}),label=u'播放地址',max_length=100)
    ...
    class Meta:
        model = FilmInfo
        fields=['film_name','region','genres','language','image']
